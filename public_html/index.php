...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="/~group01/project/"><?php echo '<img src="pcpartsrusTransparent.png"  width="100" height="auto">'; ?> </a>
            <button
        ...
        <?php 
            ...
            if ($conn->connect_error)
                ...
                while($row = $result->fetch_array()){
                    ...
                    echo "<a href=\"http://pluto.cse.msstate.edu/~group01/project/item.php\">";
