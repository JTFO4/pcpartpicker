    ...
    <body>
      ...
      <div class="row">
          ...
          <div class="col-md-4 form-group">
              <p align="center"> Welcome to PC Parts 'R Us! Click the button below to return to the homepage.</p>
      ...
      <div class="container" style="text-align: center">
          <button  onclick="document.location.href='/~group01/project/index.html'" style="text-align: right" type="submit" name="goHomeButton" class="btn btn-primary">Go Home</button>
          </div>
