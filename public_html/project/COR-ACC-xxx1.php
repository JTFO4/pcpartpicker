  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-ACC-xxx1.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
        <h4>Corsair K95 RGB PLATINUM Mechanical Gaming Keyboard, Cherry MX Brown, Backlit RGB LED, Black</h4>
          <ul>
            <li>Aircraft-grade anodized brushed aluminum frame, built to withstand a lifetime of gaming</li>
            <li>8 MB profile storage with hardware macro and lighting playback allow access to up to three stored profiles on the go, independent of external software</li>
            <li>Per-key RGB backlighting and 19-zone LightEdge delivers dynamic and vibrant lighting effects with virtually unlimited customization</li>
            <li>100% CHERRY MX Brown RGB mechanical key switches</li>
            <li>6 programmable G-keys for in-game macros</li>
            <li>Ultrafast 1ms polling to ensure a lag-free response for all of your movements</li>
            <li>CUE support enables sophisticated macro programming and dynamic, multicolor lighting effects</li>

          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-ACC-xxx1"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-ACC-xxx1.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-ACC-xxx1.php">
