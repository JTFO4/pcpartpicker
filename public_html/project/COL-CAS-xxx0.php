  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COL-CAS-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>MasterCase MC500 Mid-Tower ATX Case w/ FreeForm Modular, Tempered Glass Side Panel, Handles, Radiator Support by Cooler Master</h4>
          <ul>
            <li>FreeForm Modular System - Easily customize, adjust, and upgrade your case, inside and out, Removable partition panel isolates power supply and cables for clean management</li>
            <li>Drop-proof Side Panels - unique bracket holds the side panels from falling down while installing or removing, Clip and Click drive cage adjustment, Clip and Clip SDD cage</li>
            <li>Clear View Inside - An edge-to-edge light grey tinted tempered glass side panel gives a wide view inside your PC to showcase your masterpiece.</li>
            <li>Flexible Dual Chamber Design - Removable partition panel isolates power supply and cables for clean management</li>
            <li>Radiator Support- Front supports up to 360mm Radiator, Top supports up to 240mm Radiator, Rear supports up to 140mm Radiator</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COL-CAS-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COL-CAS-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COL-CAS-xxx0.php">
