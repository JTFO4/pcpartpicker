  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
        <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-ACC-xxx2.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
        <h4>Corsair Gaming VOID PRO RGB Wireless Premium Gaming Headset with Dolby Headphone 7.1, White</h4>
          <ul>
            <li>Microfiber mesh fabric and memory foam provide exceptional comfort</li>
            <li>Legendary CORSAIR build quality ensures long term durability</li>
            <li>Custom tuned 50mm neodymium speaker drivers bring the action to life with wide range and accuracy</li>
            <li>Enjoy crystal clear, low latency, wireless audio with up to 40 Feet range and up to 16 hours of battery life</li>
            <li>Genuine Dolby Headphone 7.1 surround delivers immersive multi-channel audio</li>
            <li>Discord Certified for crystal clear communication and outstanding sound</li>
            <li>CUE software gives you full control over your headset’s features through an intuitive and simple to use interface and lets you sync with other Corsair RGB devices</li>

          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-ACC-xxx2"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-ACC-xxx2.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-ACC-xxx2.php">
