  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-CAS-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>CORSAIR Obsidian Series 500D RGB SE Mid Tower Case, Premium Tempered Glass and Aluminum, LL120 Fans and Commander PRO Included</h4>
          <ul>
            <li>Iconic Obsidian style, with a beautiful tempered glass front panel and clean exterior lines.</li>
            <li>Premium tempered glass and aluminum construction, with solid aluminum top plate and door handles.</li>
            <li>Three LL120 RGB fans create a symphony of stunning RGB lighting.</li>
            <li>Integrated CORSAIR Commander PRO offers full software control of your cooling and RGB lighting</li>
            <li>Cooling made easy with removable front and top fan trays.</li>
            <li>Future-proof front panel with USB 3.1 Type-C</li>
            <li>Easy to clean front, top and PSU dust filters for a low maintenance case that always looks its best.</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-CAS-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-CAS-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-CAS-xxx0.php">
