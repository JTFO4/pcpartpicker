  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-ACC-xxx3.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
        <h4>CORSAIR GAMING ST100 RGB Premium Headset Stand with 7.1 Surround Sound</h4>
          <ul>
            <li>Durable aluminum construction and iconic design, combine to create the ultimate display for your headset</li>
            <li>Dynamic RGB lighting across 9 zones allows for virtually unlimited color options</li>
            <li>Built-in 3.5mm analog input enables full range stereo or 7.1 surround sound for an immersive, multi-channel audio experience</li>
            <li>Easy access, dual USB 3.1 inputs provide improved charging power and faster data speeds for your headset, phone and other devices</li>
            <li>CUE software controls RGB lighting and audio settings, and syncs with other CORSAIR RGB devices via an intuitive and simple to use interface</li>
            <li>Non-slip, rubberized base provides stability and protection for your desk</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-ACC-xxx3"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-ACC-xxx3.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-ACC-xxx3.php">
