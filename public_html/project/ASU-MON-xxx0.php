  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/ASU-MON-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>ASUS VZ239H Frameless 23” 5ms (GTG) IPS Widescreen LCD/LED Monitors, HDMI 1920 x 1080 Ultra-Slim Design, w/ Eye Care Feature and Flicker Free Technology, 178/178 Viewing Angle and Build in Speakers</h4>
          <ul>
            <li>23" Full HD (1920 x 1080) IPS monitor</li>
            <li>HDMI and VGA ports</li>
            <li>Stereo 1.5W speakers</li>
            <li>0.27" ultra slim body with frameless design</li>
            <li>ASUS EyeCare technology</li>
            <li>ASUS Rapid replacement for 3 years</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "ASU-MON-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/ASU-MON-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="ASU-MON-xxx0.php">
