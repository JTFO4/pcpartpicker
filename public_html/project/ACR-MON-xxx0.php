  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/ACR-MON-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>Acer Predator X27 27" 4K IPS UHD 3840x2160 NVIDIA G-SYNC HDR, 1,000nits (Peak), 144Hz (Overclock), 4ms (GTG), 10Bit Colors, Quantum Dot, DCI-P3, DisplayPort 1.4, Light Sensor</h4>
          <ul>
            <li>27" 4K UHD (3840 x 2160 IPS) display</li>
            <li>144Hz (overclocked) refresh rate & 4ms (GTG) Response time eliminates ghosting</li>
            <li>NVIDIA G-SYNC HDR for seamless tear-free gaming</li>
            <li>Brightness of up to 1000 nits (Peak)</li>
            <li>HDMI 2.0, DisplayPort 1.4, USB 3.0 x 4</li>
            <li>Quantum Dot technology for optimized colors</li>
            <li>VisionCare technology helps reduce eye strain and fatigue during long use</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "ACR-MON-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/ACR-MON-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="ACR-MON-xxx0.php">
