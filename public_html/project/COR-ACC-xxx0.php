  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-ACC-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
        <h4>Corsair Gaming SCIMITAR PRO RGB Gaming Mouse, Backlit RGB LED, 16,000 dpi, MMO, Yellow, Optical</h4>
          <ul>
            <li>Exclusive Key Slider macro button control system provides unmatched customization for any play style</li>
            <li>Mechanical side buttons designed to pro player specifications for consistent, tactile feed back and precise actuation</li>
            <li>Onboard storage with hardware macro playback to take your gaming profiles with you</li>
            <li>Custom, gaming grade native 16000 dpi optical sensor with 1 dpi resolution steps for high accuracy performance</li>
            <li>Surface calibration utility for maximizing precision and responsiveness</li>
            <li>Ultrafast 1ms polling to ensure a lag-free response for all of your movements</li>
            <li>CUE software control enables you to program custom MMO timer countdowns, double macros, DPI matrices, and more</li>

          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-ACC-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-ACC-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-ACC-xxx0.php">
