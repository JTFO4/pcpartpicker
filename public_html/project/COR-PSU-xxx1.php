  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-PSU-xxx1.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>CORSAIR RMx White Series RM850x White (CP-9020188-NA) 850W 80 PLUS Gold Certified, Fully Modular Power Supply, 10 Year Warranty</h4>
          <ul>
            <li>ATX12V / EPS12V</li>
            <li>Full Modular</li>
            <li>80 PLUS GOLD Certified</li>
            <li>100 - 240 V 47 - 63 Hz</li>
            <li>+3.3V@25A, +5V@25A, +12V@70.8A, -12V@0.8A, +5VSB@3A</li>
            <li>100% industrial-grade, 105°C rated Japanese capacitors ensure unwavering power and reliability</li>
            <li>Zero RPM fan mode for near-silent operation at low to medium loads.</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-PSU-xxx1"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-PSU-xxx1.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-PSU-xxx1.php">
