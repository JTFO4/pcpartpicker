  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/ALN-MON-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>Dell Alienware AW3418DW 34" Curved WQHD 4ms(GTG) 120Hz NVIDIA G-Sync Gaming Monitor, 300 cd/m², DP, HDMI, USB3.0, Tilt, Swivel, Height-Adjustable</h4>
          <ul>
            <li>34" WQHD IPS Panel with 4ms & 120Hz</li>
            <li>DP1.2, HDMI1.4, 4xUSB3.0</li>
            <li>NVIDIA G-SYNC Technology</li>
            <li>Alienware design & AlienFX Lighting</li>
            <li>Gaming-centric On-ScreenDisplay (OSD)</li>
            <li>Tilt, swivel and height adjustments</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "ALN-MON-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/ALN-MON-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="ALN-MON-xxx0.php">
