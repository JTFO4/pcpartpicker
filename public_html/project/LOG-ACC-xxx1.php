  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/LOG-ACC-xxx1.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
        <h4>Logitech G810 Orion Spectrum RGB Mechanical Gaming Keyboard</h4>
          <ul>
            <li>Pure Performance-Driven Design: Full-size keyboard delivers peak performance with the most powerful Logitech G technologies</li>
            <li>Ultra-Responsive Romer-G Mechanical Key Switches: Up to 25% faster key actuation than standard mechanical switches</li>
            <li>Customizable RGB Lighting: Match your system's look and personalize individual key lighting from a spectrum of 16.8 million colors</li>
            <li>Easy-Access Media Controls: Play, pause, mute, adjust volume and skip songs right from the keyboard</li>
            <li>Customizable Function Keys: Program custom macros to F1 - F12 keys with Logitech Gaming Software</li>
            <li>Compatibility: Works with Windows 10, Windows 8.1, Windows 8, Windows 7</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "LOG-ACC-xxx1"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/LOG-ACC-xxx1.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="LOG-ACC-xxx1.php">
