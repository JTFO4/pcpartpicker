...
<html>
    ...
    ?>
     ...
     <div class = "font-weight-bold"><font style="font-size: 80px">Reset Password</font></div>
    </div>
      <div class="container" style="padding-top: -2em">

        <form method="post" action="changeUserPass.php">
          <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4  form-group">
              <label for="userPassword">Old Password</label>
              <input type="password" class="form-control" name="oldPass" id="oldPass" aria-describedby="emailHelp" placeholder="Enter old password"> 
              <?php echo "<p style=\"color: red\">" . $GLOBALS['errOldPass'] . "</p>"; ?>
            </div>
            <div class="col-md-4"></div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group">
              ...
              <input type="password" class="form-control" name="newPass" id="newPass" aria-describedby="emailHelp" placeholder="Enter new password">
              <?php echo "<p style=\"color: red\">" . $GLOBALS['errNewPass'] . "</p>"; ?>
            </div>
            <div class="col-md-4"></div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group">
              ...
              <input type="password" class="form-control" name="confirmPass" id="confirmPass" aria-describedby="emailHelp" placeholder="Confirm new password">
            </div>
            <div class="col-md-4"></div>
          </div>
          ...
          <div class="row" style="padding-top: 1em">
            ...
            <div class="col-md-auto">
              <button type="submit" name="confirmButton" id ="confirm" class="btn btn-secondary">Confirm</button>
            </div>
            <div class="col-md-auto">
            </div>
          </div>
