  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/DEP-CAS-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>DEEPCOOL Gamer Storm QUADSTELLAR Full-Tower four cabin Case Supporting E-ATX motherboard 120/240/360mm water cooling system Tempered Glass APP and Motherboard Controlled RGB Lighting System</h4>
          <ul>
            <li>Smart full-tower case Supports E-ATX MB.</li>
            <li>4 Automatic opened front doors, can be also controlled by APP under WiFi</li>
            <li>APP controllable RGB Lighting System or cable controlled by +5V/D/GND 3PIN ADD-HEADER on Motherboard</li>
            <li>4 magnet fixed Tempered glass window</li>
            <li>5pcs black 120mm 2-layer blade patented fans (TF120) pre-installed</li>
            <li>Precise aluminum die casting technology for front framework</li>
            <li>Independent VGA cabin supports 3pcs graphics cards SLI/CROSS FIRE</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "DEP-CAS-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/DEP-CAS-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="DEP-CAS-xxx0.php">
