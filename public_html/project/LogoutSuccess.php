                ...
                <ul class="navbar-nav ml-auto">
                    <?php 
                        ...
                        if(isset( $_SESSION['isLoggedIn'] ) && ($_SESSION['isLoggedIn'] == 1)){
                            ...
                            <li class=\"nav-item active\"><a class=\"nav-link\" href=\"/~group01/project/LogoutSuccess.php\">Log out</a></li>";
                        } else {
    ...
    <div class = "font-weight-bold"><font style="font-size: 80px">PC Parts 'R' Us</font></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                <p style="text-align: center"> You've successfully logged out. Click the button below to return to the homepage.</p>
            </div>
            <div class="col-md-4"></div>
        </div>
        <div class="container" style="text-align: center">
            <button  onclick="document.location.href='/~group01/project/index.php'" style="text-align: right" type="submit" name="goHomeButton" class="btn btn-secondary">Go Home</button>
        </div>
    </body>
