  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/COR-CAS-xxx1.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>CORSAIR Crystal 570X RGB Tempered Glass, Premium ATX Mid Tower Case, White</h4>
          <ul>
            <li>Four tempered glass panels on the front, top, and sides of the case</li>
            <li>Three included SP120 RGB LED fans and integrated RGB controller</li>
            <li>Room for up to six case fans, and compatible with 360mm, 280mm, 240mm, and 120mm radiators</li>
            <li>Removable fan trays in the front and top of the chassis</li>
            <li>Cable routing channels with included velcro cable straps for clean cable management</li>
            <li>Easy-access high-speed USB 3.0 front panel</li>
            <li>Bright white LED backlit CORSAIR logo on front panel and PSU cover (removable)</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "COR-CAS-xxx1"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/COR-CAS-xxx1.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="COR-CAS-xxx1.php">
