  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/ASU-MOM-xxx2.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>ASUS Prime Z390-A LGA 1151 (300 Series) Intel Z390 HDMI SATA 6Gb/s USB 3.1 ATX Intel Motherboard</h4>
          <ul>
            <li>Designed for 9th and 8th generation Intel Core processors to maximize connectivity and speed with dual M.2, USB 3.1 Gen 2, onboard 802.11 ac Wi-Fi and ASUS OptiMem II for better DRAM overclocking stability</li>
            ...
            <li>5X Protection III Hardware-level safeguards with SafeSlot Core, LANGuard and Overvoltage Protection provide component longevity and reliability while FanXpert 4 with AIO Pump Header delivers advanced fan control for dynamic system cooling</li>
            <li>Unique SafeSlot Core fortified PCIe slots prevent damage caused by heavyweight GPUs</li>
            <li>Realtek ALC S1220A 8-Channel High Definition Audio CODEC featuring Crystal Sound 3</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "ASU-MOM-xxx2"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/ASU-MOM-xxx2.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="ASU-MOM-xxx2.php">
