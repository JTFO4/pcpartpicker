  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/GIG-MOM-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>GIGABYTE X399 AORUS XTREME sTR4 AMD X399 SATA 6Gb/s USB 3.1 Extended ATX AMD Motherboard</h4>
          <ul>
            <li>AMD X399</li>
            <li>SocketTR4:</li>
            <li>AMD Ryzen Threadripper processor</li>
            <li>Support for DDR4 3600+*(O.C.)/ 3466+(O.C.)/ 2933/ 2667/ 2400/ 2133 MHz memory modules</li>
            <li>* Recommend to use a 1st Gen. Ryzen Threadripper processor to achieve 3600 MHz (O.C.) speed.</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "GIG-MOM-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/GIG-MOM-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="GIG-MOM-xxx0.php">
