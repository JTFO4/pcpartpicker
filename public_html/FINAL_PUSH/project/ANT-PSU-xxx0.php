  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container" style="padding-top: 5em">
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="http://pluto.cse.msstate.edu/~group01/project/ItemPics/ANT-PSU-xxx0.jpg" style="width:350px; height:auto"/> <!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE --><!-- PLUTO LINK TO PIC HERE -->
        </div>
        <!-- div contains item name & information -->
        <div class="col-md-4">
          <h4>Antec EDG 650 650W ATX12V / EPS12V 80 PLUS GOLD Certified Full Modular Power Supply</h4>
          <ul>
            <li>ATX12V / EPS12V</li>
            <li>Full Modular</li>
            <li>80 PLUS GOLD Certified</li>
            <li>100 - 240 V 50/60 Hz</li>
            <li>+3.3V@20A, +5V@20A, +12V1@35A, +12V2@35A, -12V@0.3A, +5VSB@2.5A</li>
          </ul>

          <!-- implement logic to hide based on stock status -->
          <?php
          $sku = "ANT-PSU-xxx0"; //ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  ITEM SKU HERE ---  
          ...
          $stock = $row['stockQuantity'];
            ...
            if($row['salePrice'] != NULL && $row['salePrice'] != -0.01) 
              ...
              if(isset($_POST['removeItemFromStore'])){
                ...
                $conn->close();
                echo "<script>";
                echo "window.location = 'http://pluto.cse.msstate.edu/~group01/project/ANT-PSU-xxx0.php';";
                echo "</script>";
                }
              }
        ...
        <div class="form-group col-md-4">
          <form method="post" action="ANT-PSU-xxx0.php">
